...
PM_START_TEXT = """
Hello *{}*
My name is *{}*, a powerful telegram bot to music service and manage your groups!
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/3993375ff8ec016280405.png"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help & Commands",callback_data="help_back"),InlineKeyboardButton(text="➕ Add to group",url="t.me/{}?startgroup=true".format(bot.username))]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="Help & Commands",url="t.me/{}?start=help".format(bot.username))]]))
        return
