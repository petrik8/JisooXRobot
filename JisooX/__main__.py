...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help & Commands",callback_data="help_back"),InlineKeyboardButton(text="[► Add Me ◄]",url="t.me/{}?startgroup=true".format(bot.username))]]
